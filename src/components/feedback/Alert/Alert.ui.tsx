...
const ALERT_ROLE = {
  ...
  warning: 'alert',
  danger: 'alert',
} as const satisfies Record<AlertVariant, 'status' | 'alert'>;

/**
 * 사용자에게 피드백 메시지를 전달하는 알림 컴포넌트
 */
export function Alert({
  ...
  const classNames = ['ds-alert', `ds-alert--${variant}`, className]
    .filter(Boolean)
    .join(' ');
